...
<head>
    ...
    <title>Sistem Pelaporan Pencetakan KTP</title>
	<!-- Bootstrap Styles-->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="/datapelaporan"><i class="fa fa-fw fa-table"></i>Data Pencetakan</a>
                    </li>
                </ul>
        ...
        <div id="page-wrapper">
		  ...
		  <div class="header"> 
                        <h1 class="page-header">
                            Registrasi Pelaporan Dalam Daerah
                        </h1>
						<ol class="breadcrumb">
					        <li><a href="#">Home</a></li>
					        <li class="active">Pelaporan Dalam Daerah</li>
					    </ol>        
            <div class="row">
                <div class="col-xs-12">					
