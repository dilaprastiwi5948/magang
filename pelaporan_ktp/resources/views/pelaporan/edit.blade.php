            ...
            <div class="card-body"> @if ($errors->any())
                ...
                <form method="post" action="{{ route('pelaporan.update', $Pelapor->nik_pelapor) }}" id="myForm">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" type="jenis_pelaporan" name="jenis_pelaporan" class="form-control" id="jenis_pelaporan"
                            aria-describedby="jenis_pelaporan" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_lahir" class="form-control" id="tanggal_lahir"
                            value="{{ $Pelapor->tanggal_lahir }}" aria-describedby="tanggal_lahir" required>
                    </div>
                    <div class="form-group">
                        <label for="alamat">Alamat</label>
                        <input type="alamat" name="alamat" class="form-control" id="alamat" aria-describedby="alamat"
                            required value="{{ $Pelapor->alamat }}">
                    </div>
                    <div class="form-group">
                        <label for="kelurahan">Desa / Kelurahan</label>
                        <input type="kelurahan" name="kelurahan" class="form-control" id="kelurahan"
                            aria-describedby="kelurahan" required value="{{ $Pelapor->kelurahan }}">
                    </div>
                    <div class="form-group">
                        <label for="kecamatan">Kecamatan</label>
                        <input type="kecamatan" name="kecamatan" class="form-control" id="kecamatan"
                            aria-describedby="kecamatan" required value="{{ $Pelapor->kecamatan }}">
                    </div>
                    <div class="form-group">
                        <label for="kota">Kabupaten / Kota</label>
                        <input type="kota" name="kota" class="form-control" id="kota" aria-describedby="kota" required
                            value="{{ $Pelapor->kota }}">
                    </div>
                    <div class="form-group">
